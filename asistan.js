...
(function () {
  ...
  var BILGI = [
    ...
    { k: ['infaz', 'kac yil yatar', 'ne kadar yatar', 'yatar hesap', 'kosullu saliverilme', 'denetimli serbestlik', 'ne zaman cikar', 'cezaevinden ne zaman'], c: 'Hapis cezasında koşullu salıverilme oranı genel suçlarda 1/2, kasten öldürme, cinsel suçlar, uyuşturucu ticareti ve örgüt suçları gibi suçlarda 2/3\'tür. Kural olarak koşullu salıverilmeye 1 yıl kala denetimli serbestliğe ayrılmak mümkündür. Gözaltı ve tutuklulukta geçen süre cezadan düşülür. Tahmini hesap için infaz hesaplama aracımızı kullanabilirsiniz.', l: [{ t: 'İnfaz hesaplama aracı', u: '/araclar/infaz-hesaplama.html' }], r: true },
    { k: ['hesaplama', 'hesapla', 'hesap araci', 'son gun', 'sure hesap', 'ne zamana kadar'], c: 'Sitemizde ücretsiz hesaplama araçları bulunuyor: infaz hesaplama, yasal süre (son gün) hesaplama, kıdem-ihbar tazminatı ve kira artış hesaplama.', l: [{ t: 'Hesaplama araçları', u: '/araclar.html' }, { t: 'Süre hesaplama', u: '/araclar/sure-hesaplama.html' }], r: false },
    ...
    { k: [' fon ', ' fonu', ' fonum', ' fona ', ' fonda', ' fonlar', 'yatirim fonu', 'fon magdur', 'fon sorusturma', 'tasfiye', 'tefas', 'portfoy', ' tera ', 'pusula', ' spk', 'manipulasyon', 'piyasa dolandir', 'katilma pay'], c: 'SPK\'nın 17 Eylül 2026 kararıyla 130 fon tasfiyeye alındı. Fon varlıkları portföy yönetim şirketinin malvarlığından ayrıdır ve tasfiye gelirleri yatırımcılara payları oranında dağıtılır; karardan önce verilen iade talimatları öncelikli olabilir. Ceza soruşturmasında şikâyetçi olabilir, fonu size satan banka veya aracı kurumun eksik bilgilendirmesi varsa ayrıca tazminat talep edebilirsiniz. Dekontlarınızı, talimat saatinizi gösteren ekran görüntülerini ve yazışmalarınızı saklayın. \"Paranızı kurtaralım\" diyerek ücret isteyenlere itibar etmeyin.', l: [M('fon-magdurlari-ne-yapmali-tasfiye-sikayet-tazminat-2026', 'Fon mağdurları ne yapmalı?'), H('fon-sorusturmasi-130-fon-tasfiye-yatirimci-haklari-2026', 'Fon soruşturmasında son durum'), { t: 'Fon ile ilgili emsal kararlar', u: '/emsal-kararlar.html#fon' }, D('yatirim-fonu-zarari-suc-duyurusu-katilma-dilekce', 'Fon zararı şikâyet dilekçesi')], r: true },
    ...
    { k: ['istinaf'], c: 'İstinaf, ilk derece mahkemesi kararının Bölge Adliye Mahkemesi\'nde yeniden incelenmesidir. Ceza davalarında istinaf süresi, hükmün açıklanmasından (yokluğunda verilmişse tebliğden) itibaren 2 haftadır.', l: [{ t: 'Süre hesaplama aracı', u: '/araclar/sure-hesaplama.html' }, D('ceza-istinaf-basvuru-dilekcesi', 'Ceza istinaf dilekçesi')], r: true },
    { k: ['temyiz', 'yargitay', 'bozma'], c: 'Temyiz, Bölge Adliye Mahkemesi kararlarının Yargıtay tarafından hukuki denetimidir. Ceza davalarında temyiz süresi kararın tefhim veya tebliğinden itibaren 2 haftadır. Bu süreler hak düşürücüdür.', l: [{ t: 'Süre hesaplama aracı', u: '/araclar/sure-hesaplama.html' }, D('ceza-temyiz-dilekcesi', 'Ceza temyiz dilekçesi')], r: true },
    ...
    // ---------- İŞ ----------
    { k: ['kidem', 'kidem tazminati'], c: 'Kıdem tazminatı, en az 1 yıl çalışmış işçiye her tam yıl için 30 günlük giydirilmiş brüt ücret üzerinden ödenir. 1 Temmuz–31 Aralık 2026 döneminde bir yıl için ödenebilecek en yüksek tutar 73.729,87 TL\'dir. Zamanaşımı 5 yıldır; dava öncesi arabulucuya başvurmak zorunludur.', l: [H('kidem-tazminati-tavani-temmuz-2026', 'Kıdem tazminatı tavanı'), M('kidem-tazminati-hesaplama-2026', 'Kıdem tazminatı hesaplama'), { t: 'Kıdem ve ihbar tazminatı hesaplama aracı', u: '/araclar/kidem-ihbar-hesaplama.html' }], r: true },
